      ...
      <li class="nav-item">
        ...
        <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="<?= base_url('Desa'); ?>">Data Desa</a>
          </div>
        </div>
      </li>
<?php } ?>
      ...
      <li class="nav-item">
        ...
        <div id="collapseUtilitiess" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <a class="collapse-item" href="<?= base_url('Laporan'); ?>">Laporan dana Desa</a>
            <a class="collapse-item" href="<?= base_url('Laporan/pekerjaan'); ?>">Laporan Pekerjaan</a>
          </div>
        </div>
      </li>
